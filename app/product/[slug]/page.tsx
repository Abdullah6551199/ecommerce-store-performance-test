...
export default async function ProductDetailsPage({ params }: ProductPageProps): Promise<React.JSX.Element> {
  ...
  return (
    <>
      ...
      {product.description && (
        <section className="rounded-3xl border border-white/10 bg-[#0c140f]/60 p-6 sm:p-8 backdrop-blur-md space-y-4">
          ...
          <div className="prose prose-invert max-w-none text-sm text-white/70 whitespace-pre-line leading-relaxed">
            {product.description}
          </div>
        </section>
      )}
        ...
        <section className="space-y-6 pt-6 border-t border-white/10">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-white/50">Other popular items from this category.</p>
            </div>
