...
export default function StorefrontWishlistPage(): React.JSX.Element {
  ...
  if (!isInstalled) {
    return (
      <div className="max-w-2xl mx-auto my-16 p-12 text-center rounded-3xl border border-purple-100 dark:border-purple-900/40 bg-white dark:bg-[#1E0230] shadow-sm">
