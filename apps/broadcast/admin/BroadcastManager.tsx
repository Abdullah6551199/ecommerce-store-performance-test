...
import type { BroadcastAdminItem } from "../shared/types";
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-6 sm:p-8 shadow-sm space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl border border-zinc-200 dark:border-zinc-800 text-xs font-bold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition cursor-pointer"
          >
            Refresh
          </button>
        </div>
                  ...
                  <tr key={b.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30 transition">
                    ...
                    <td className="py-4 px-4 text-right">
                      <button
                        ...
                        className="text-red-500 hover:text-red-700 font-bold text-[11px] transition cursor-pointer"
                      >
                        Delete
                      </button>
                    </td>
