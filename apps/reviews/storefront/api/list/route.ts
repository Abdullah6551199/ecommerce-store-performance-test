...
/**
 * GET /api/reviews/list (or apps/reviews/storefront/api/list)
 * Returns approved reviews for a product and its aggregate rating breakdown.
 */
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("[GET apps/reviews/storefront/api/list] Error:", error);
    return NextResponse.json(
