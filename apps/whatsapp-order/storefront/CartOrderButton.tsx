 ...
 * Appears directly below the "Proceed to Checkout" button and matches its exact dimensions.
 */
  ...
  return (
    <div data-app="whatsapp-order" className="w-full mt-3">
      <a
        ...
        className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] py-3.5 text-sm font-bold text-white shadow-lg shadow-emerald-500/20 transition-all cursor-pointer active:scale-[0.99]"
      >
        <svg
