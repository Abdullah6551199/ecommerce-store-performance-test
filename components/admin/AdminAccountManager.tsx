    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0d1611] p-6 shadow-lg">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-white/5 p-4">
            <span className="text-[10px] font-semibold uppercase tracking-wider text-zinc-500 dark:text-white/50">
              Admin Email
            </span>
            <p className="mt-1 text-sm font-semibold text-zinc-900 dark:text-white truncate" id="admin-display-email">
              {currentEmail}
            </p>
          </div>
          <div className="rounded-xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-white/5 p-4">
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-white/5 bg-zinc-50 dark:bg-white/5 p-4">
            ...
            <p className="mt-1 text-sm font-semibold text-amber-600 dark:text-[#FEF500]">Active & Verified</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0d1611] p-6 shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold text-zinc-900 dark:text-white">Update Admin Email</h2>
      ...
      <div className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0d1611] p-6 shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold text-zinc-900 dark:text-white">Update Admin Password</h2>
            <p className="text-xs text-zinc-500 dark:text-white/50">
