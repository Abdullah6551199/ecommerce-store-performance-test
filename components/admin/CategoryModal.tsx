...
export default function CategoryModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl rounded-3xl border border-white/15 bg-[#0a110c] p-6 sm:p-8 shadow-2xl transition-all">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="category-modal-title" className="text-xl font-bold tracking-tight text-white">
        ...
        {/* Error Alert */}
        {errorMessage && (
          <div className="mt-4 rounded-xl border border-red-500/30 bg-red-500/10 p-3.5 text-xs text-red-400 flex items-start gap-2.5">
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4 max-h-[70vh] overflow-y-auto pr-1">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="category-name" className="block text-xs font-semibold text-white/80">
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-xl border border-white/15 bg-white/5 px-3.5 py-2.5 text-sm text-white placeholder-white/30 focus:border-[#18C729] focus:outline-none focus:ring-1 focus:ring-[#18C729]"
              />
            </div>

            <div>
              <div className="flex items-center justify-between">
                <label htmlFor="category-slug" className="block text-xs font-semibold text-white/80">
              ...
              <input
                ...
                placeholder="e.g. streetwear"
                className="mt-1.5 w-full font-mono rounded-xl border border-white/15 bg-white/5 px-3.5 py-2.5 text-sm text-white placeholder-white/30 focus:border-[#18C729] focus:outline-none focus:ring-1 focus:ring-[#18C729]"
              />
            </div>
          </div>
          ...
          {/* Description */}
          <div>
            <label htmlFor="category-description" className="block text-xs font-semibold text-white/80">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div>
              <label htmlFor="category-parent" className="block text-xs font-semibold text-white/80">
                Parent Category
              </label>
              <select
                id="category-parent"
                ...
                className="mt-1.5 w-full rounded-xl border border-white/15 bg-[#0e1610] px-3 py-2.5 text-xs text-white focus:border-[#18C729] focus:outline-none focus:ring-1 focus:ring-[#18C729]"
              >
            ...
            <div>
              <label htmlFor="category-status" className="block text-xs font-semibold text-white/80">
                Status
              </label>
              <select
                id="category-status"
            ...
            <div>
              <label htmlFor="category-sort" className="block text-xs font-semibold text-white/80">
                Sort Order
              </label>
              <input
                id="category-sort"
          ...
          <div className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-xs font-semibold text-white/90">Category Image</span>
                <p className="text-[11px] text-white/50">Direct upload to Cloudflare R2 bucket (PNG, JPG, WebP &le; 5MB)</p>
              </div>
              {imageUrl && (
                <button
                  type="button"
            ...
            {imageUrl ? (
              ...
              <div>
                ...
                <button
                  ...
                  className="flex w-full flex-col items-center justify-center rounded-xl border border-dashed border-white/20 bg-white/5 p-4 text-center hover:border-[#18C729]/50 hover:bg-[#18C729]/5 transition-all"
                >
                  {isUploading ? (
          ...
          {/* SEO Accordion */}
          <details className="rounded-2xl border border-white/10 bg-black/20 p-4 transition-all">
            <summary className="cursor-pointer text-xs font-semibold text-white/80 hover:text-white flex items-center justify-between">
            ...
            <div className="mt-4 space-y-3 pt-2 border-t border-white/10">
              <div>
                <div className="flex justify-between items-center">
                  <label htmlFor="category-seo-title" className="text-xs text-white/70">
                    SEO Title
                  </label>
              ...
              <div>
                <div className="flex justify-between items-center">
                  <label htmlFor="category-seo-description" className="text-xs text-white/70">
                    SEO Description
                  </label>
          ...
          <div className="mt-6 flex items-center justify-end gap-3 pt-4 border-t border-white/10">
            <button
              ...
              className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-xs font-medium text-white/70 hover:bg-white/10 hover:text-white transition-colors"
            >
              Cancel
            </button>
            <button
