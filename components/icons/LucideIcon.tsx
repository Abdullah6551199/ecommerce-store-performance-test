...
// 50+ Popular Lucide Icons SVG Path Definitions
export const LUCIDE_ICONS: Record<string, (size: number) => React.ReactNode> = {
  // Security & Trust
  "shield-check": (s) => (
    <>
...
function LucideIconComponent({
  ...
  const normalized = (name || "shield-check").toLowerCase().trim();
  const renderIcon = LUCIDE_ICONS[normalized] || LUCIDE_ICONS["shield-check"];
