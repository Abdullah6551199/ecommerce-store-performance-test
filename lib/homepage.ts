...
export const DEFAULT_HOMEPAGE_SECTIONS: Array<Omit<HomepageSectionRecord, "createdAt" | "updatedAt">> = [
  {
    ...
    content: {
      ...
      subheading: "Discover precision athletic gear crafted for high-intensity training, trail endurance, and everyday speed. Explore precision footwear, dynamic apparel, and elite equipment.",
      badgeText: "New Season Collection • Engineered For Speed",
  ...
  },
  {
    ...
    content: {
      ...
      subheading: "Hand-picked performance essentials crafted for intense training and daily endurance.",
      badgeText: "Featured Performance",
      maxItems: 4,
      viewAllUrl: "/search",
    },
  },
  ...
  },
  {
    ...
    isActive: true,
    content: {
      heading: "Built at the Intersection of Innovation & Human Potential",
      subheading: "Our Manifesto",
      narrativeText: "We engineer apparel and equipment with relentless attention to biomechanics and endurance. Featherlight materials, hyper-durable composites, and uncompromising ergonomics for athletes who refuse to settle.",
      statItems: [
        { label: "Fast Dispatch", value: "< 24h", desc: "Express delivery dispatch" },
        { label: "Energy Return", value: "+32%", desc: "Carbon-matrix tech" },
        { label: "Active Athletes", value: "25,000+", desc: "Worldwide community" },
        { label: "Customer Rating", value: "99.4%", desc: "Verified athlete satisfaction" },
      ],
