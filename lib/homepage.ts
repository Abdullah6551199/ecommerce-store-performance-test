...
export const DEFAULT_HOMEPAGE_SECTIONS: Array<Omit<HomepageSectionRecord, "createdAt" | "updatedAt">> = [
  ...
  },
  {
    ...
    content: {
      ...
      subheading: "Experience 32% greater energy return with our award-winning composite foam and zero-friction matrix. Engineered for athletes who push boundaries.",
      badgeText: "Limited Edition Release",
      buttonText: "Discover Velocity",
      buttonUrl: "/shop",
      bannerStyle: "split",
    },
  },
  {
    id: "sec-brand-story",
    type: "brand_story",
    title: "Performance Manifesto",
    imageUrl: "https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=1200&auto=format&fit=crop",
    sortOrder: 6,
    isActive: true,
    content: {
      heading: "Built at the Intersection of Innovation & Human Potential",
      subheading: "Our Performance Manifesto",
      narrativeText: "We engineer apparel and equipment with relentless attention to biomechanics and endurance. Featherlight materials, hyper-durable composites, and uncompromising ergonomics for athletes who refuse to settle. Every product is stress-tested in elite athletic facilities.",
      statItems: [
