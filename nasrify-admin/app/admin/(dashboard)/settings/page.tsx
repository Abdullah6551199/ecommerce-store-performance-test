    ...
    <AdminErrorBoundary moduleName="Settings">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <a
          ...
          className="group rounded-2xl border border-[#E4E4E7] dark:border-zinc-800/60 bg-white dark:bg-[#18181B]/20 p-5 shadow-sm hover:border-[#25D366] dark:hover:border-[#1EA855] transition-all"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-xl bg-[#DCFCE7] dark:bg-[#18181B]/60 flex items-center justify-center text-[#1EA855] dark:text-zinc-400 font-bold">
                %
              </div>
              <div>
                <h3 className="text-sm font-bold text-[#18181B] dark:text-[#DCFCE7] group-hover:text-[#25D366] transition-colors">
                  Tax Management
                </h3>
                <p className="text-[11px] text-[#1EA855]/70 dark:text-zinc-400/70 mt-0.5">
                  Country/state tax rates &amp; detection
                </p>
              </div>
            </div>
            <span className="text-[#25D366] group-hover:translate-x-1 transition-transform">&rarr;</span>
          </div>
        </a>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-xl bg-[#DCFCE7] dark:bg-[#18181B]/60 flex items-center justify-center text-[#1EA855] dark:text-zinc-400">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-xl bg-[#DCFCE7] dark:bg-[#18181B]/60 flex items-center justify-center text-[#1EA855] dark:text-zinc-400 text-lg">
                🍪
              </div>
              <div>
                <h3 className="text-sm font-bold text-[#18181B] dark:text-[#DCFCE7] group-hover:text-[#25D366] transition-colors">
