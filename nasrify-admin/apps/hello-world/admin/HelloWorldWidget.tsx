...
export default function HelloWorldWidget(): React.JSX.Element {
  return (
    <div className="rounded-2xl border border-[#E4E4E7] dark:border-zinc-800/50 bg-white dark:bg-[#150a21] p-5 shadow-sm">
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#DCFCE7] dark:bg-[#18181B]/60 text-[#25D366] dark:text-zinc-400">
