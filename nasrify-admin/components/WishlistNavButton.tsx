...
export default function WishlistNavButton(): React.JSX.Element {
  ...
  return (
    <Link
      href="/wishlist"
      className="group relative flex min-h-[48px] min-w-[48px] flex-col items-center justify-center rounded-xl border border-[#E4E4E7]/60 dark:border-white/10 bg-white/50 dark:bg-white/5 px-2.5 py-1 transition-all hover:scale-105 hover:border-red-500/50 hover:bg-white/80 dark:hover:bg-white/10 cursor-pointer shadow-sm"
    ...
    >
        ...
        <svg
          className={`h-4 w-4 transition-colors ${
            itemCount > 0
              ...
              : "text-[#18181B] dark:text-white group-hover:text-red-500"
          }`}
      ...
      <span className="text-[10px] font-bold text-[#18181B] dark:text-white/60 group-hover:text-red-500 leading-tight mt-0.5 tracking-tight transition-colors">
        Wishlist
      </span>
    </Link>
  );
