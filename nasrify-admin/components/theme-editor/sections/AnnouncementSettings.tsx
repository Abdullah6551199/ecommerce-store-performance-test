        ...
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            <input
              ...
              className="h-6 w-8 rounded cursor-pointer border border-slate-700 bg-transparent p-0"
            />
            <input
              type="text"
              value={settings.bg_color || "#18181B"}
              onChange={(e) => onChange({ bg_color: e.target.value })}
              className="w-full px-2 py-1 text-[11px] font-mono rounded border border-slate-700 bg-slate-900 text-slate-100 text-center"
            />
          </div>
        </div>
