      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            value={bg_color}
            onChange={(e) => onChange({ bg_color: e.target.value })}
            className="flex-1 bg-slate-900 border border-slate-700 rounded px-2 py-1 text-slate-200 uppercase font-mono text-xs focus:outline-none focus:border-[#25D366]"
          />
        </div>
      </div>
    </div>
