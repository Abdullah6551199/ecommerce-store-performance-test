    ...
    <section className="relative overflow-hidden rounded-3xl border border-purple-200/80 dark:border-purple-800/60 bg-gradient-to-r from-purple-50 via-purple-100 to-purple-50 dark:from-[#3C0561] dark:via-[#4c077b] dark:to-[#3C0561] p-6 sm:p-10 lg:p-14 shadow-xl shadow-purple-500/10 transition-colors">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-7 space-y-4 sm:space-y-5 text-left">
          {badge && (
            <div className="inline-flex items-center gap-1.5 rounded-full bg-[#960DF2] text-white px-3.5 py-1 text-xs font-bold uppercase tracking-wider shadow-sm">
              <span>{badge}</span>
            </div>
          )}

          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-[#3C0561] dark:text-white leading-[1.15]">
            {heading}
          </h2>

          <p className="text-base sm:text-lg font-bold text-[#780AC2] dark:text-[#EACFFC]">
            {discountText}
          </p>

          <p className="text-sm text-[#5A0891]/90 dark:text-purple-100/80 max-w-xl leading-relaxed">
            {subheading}
          </p>
        ...
        {/* Right Image */}
        <div className="lg:col-span-5 relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-square w-full overflow-hidden rounded-2xl border border-purple-200/80 dark:border-purple-700/60 shadow-xl bg-purple-100/40 dark:bg-purple-950/40">
          <Image
